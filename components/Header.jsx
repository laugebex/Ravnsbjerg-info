...
export function Header(){
  ...
  return <header className="header"><div className="wrap nav">
    ...
    <button className="menuButton" type="button" aria-label={open?'Luk menu':'Åbn menu'} aria-expanded={open} aria-controls="main-navigation" onClick={()=>setOpen(!open)}><span></span><span></span><span></span></button>
