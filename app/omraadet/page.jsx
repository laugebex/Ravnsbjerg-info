...
const description='Et kort overblik over Ravnsbjerg og nærområdet: kort, Lunden, Gjellerup Enge, skole, indkøb, Hall’n og lokalhistorie.'
...
<section className="areaHero"><div className="wrap areaHeroGrid"><div><p className="eyebrow">Ravnsbjerg · Gjellerup</p><h1>Om området</h1><p className="lead">Et kort overblik over Ravnsbjerg og det, der ligger omkring os.</p><p className="areaIntro">Her kan du orientere dig på kortet og læse mere om naturen og lokalhistorien i nærområdet.</p></div><div className="areaHeroPhoto"><img src={areaHero} width="1920" height="1440" alt="Indkørslen til Lunden ved Ravnsbjerg" fetchPriority="high"/></div></div></section>

<section className="section"><div className="wrap"><div className="sectionHead"><div><p className="eyebrow">Kort</p><h2>I nærheden</h2></div><p>Tryk på et sted under kortet for at zoome ind og se placeringen.</p></div><LocalMap/></div></section>
