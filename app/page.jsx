...
<section className="hero"><div className="wrap heroGrid"><div><p className="eyebrow">Grundejerforeningen · Gjellerup</p><h1>Ravnsbjerg</h1><p className="lead">Her finder du det, der er godt at kunne finde igen: vedtægter, referater, Lunden, hjertestarter og kontakt til bestyrelsen.</p><p className="heroFacebook">Små nyheder, arrangementer og det, der sker her og nu, ligger i <a href={facebook}>vores private Facebook-gruppe →</a></p></div><div className="visual photoHero"><img src={lunden2} width="450" height="338" alt="Lunden ved Ravnsbjerg" fetchPriority="high"/></div></div></section>
